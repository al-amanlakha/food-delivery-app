...
import 'main_course_view_model.dart';
...
class MainCourse extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<MainCourseViewModel>(
      builder: (controller) {
            ...
            SliverPadding(
              ...
              sliver: SliverList.separated(
                itemBuilder: (context, index) {
                  final model = controller.mainCourseList[index];
                ...
                itemCount: controller.mainCourseList.length,
              ),
            ),
          ],
        );
